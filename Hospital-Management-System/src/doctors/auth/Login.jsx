      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl bg-white">
        ...
        <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-indigo-600 to-violet-700 text-white p-10 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-4">
            <h2 className="text-3xl font-bold leading-snug">Welcome back,<br />Doctor.</h2>
            <p className="text-white/80 text-sm leading-relaxed max-w-sm">
              Sign in to view your appointments, patient records, and consultation requests.
            </p>
          </div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/doctors/forgot-password" className="link link-primary text-sm">Forgot password?</a>
            </div>
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <a href="/doctor-signup" className="link link-primary font-medium">Apply as a doctor</a>
          </p>
        </div>
      </div>
    </div>
