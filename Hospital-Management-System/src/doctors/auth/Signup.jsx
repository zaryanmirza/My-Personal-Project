...
const IconStethoscope = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4.8 2.3A.3.3 0 1 0 4.2 2.3.3.3 0 0 0 4.8 2.3M8 2v2.5A3.5 3.5 0 0 1 4.5 8h-1A3.5 3.5 0 0 1 0 4.5V2" transform="translate(2 0)" />
...
const IconBadge = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M8 4V2h8v2" /><path d="M9 12h6" /><path d="M9 16h6" />
  </svg>
)
...
const DoctorSignup = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-indigo-50 via-violet-50 to-purple-100 p-4">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl bg-white">
        {/* Left branding panel */}
        <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-indigo-600 to-violet-700 text-white p-10 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-wide">MediCare Pro</span>
          </div>
          <div className="relative z-10 space-y-4">
            <h2 className="text-3xl font-bold leading-snug">Join our network<br />of specialists.</h2>
            <p className="text-white/80 text-sm leading-relaxed max-w-sm">
              Manage your schedule, consult patients, and grow your practice through a single dashboard.
            </p>
          </div>
          <p className="relative z-10 text-xs text-white/70">Verified accounts only — credentials reviewed by our team.</p>
        </div>

        {/* Right form panel */}
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-slate-800">Create your doctor account</h1>
            <p className="text-slate-500 text-sm mt-1">Tell us about your practice to get verified.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="form-control w-full">
                <label className="label pb-1"><span className="label-text text-slate-600">Specialization</span></label>
                <label className="select select-bordered flex items-center gap-2 rounded-xl focus-within:select-primary">
                  <IconStethoscope className="w-4 h-4 text-slate-400" />
                  <select
                    name="specialization"
              ...
              <div className="form-control w-full">
                <label className="label pb-1"><span className="label-text text-slate-600">License Number</span></label>
                <label className="input input-bordered flex items-center gap-2 rounded-xl focus-within:input-primary">
                  <IconBadge className="w-4 h-4 text-slate-400" />
                  <input
                    type="text"
                    name="license"
                    value={form.license}
                    onChange={handleChange}
                    placeholder="PMC-000000"
                    className="grow"
                    required
                  />
                </label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="form-control w-full">
                <label className="label pb-1"><span className="label-text text-slate-600">Experience (years)</span></label>
                <label className="input input-bordered flex items-center gap-2 rounded-xl focus-within:input-primary">
                  <IconBriefcase className="w-4 h-4 text-slate-400" />
                  <input
                    type="number"
                    name="experience"
            ...
            <label className="label cursor-pointer justify-start gap-3 py-1">
              ...
              <span className="label-text text-slate-500 text-sm">
                I confirm my credentials are accurate and agree to the <a href="/terms" className="link link-primary">Terms</a>
              </span>
            </label>

            <button type="submit" className="btn btn-primary w-full rounded-xl mt-2 bg-gradient-to-r from-indigo-600 to-violet-700 border-none text-white">
              Create Account
            </button>
          </form>
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <a href="/doctors/login" className="link link-primary font-medium">Sign in</a>
          </p>
        </div>
      </div>
    </div>
